...
SIGNAL_POINTS: dict[str, float] = {
    ...
    "job_postings":          POINTS_JOB_POSTINGS,
...
_REASONS: dict[str, tuple[str, str, str]] = {
    ...
    "job_postings": (
        "Multiple active job postings found. Company is hiring and actively growing.",
        "Some job postings found, indicating moderate growth activity.",
        "No job postings found. Company does not appear to be actively hiring.",
    ),
    "portfolio_news": (
